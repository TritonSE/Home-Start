  ...
  return (
    <div className={styles.outerMostDiv}>
      ...
      <div className={styles.dashboard}>
        <div className={styles.dashboardInnerFrame}>
          <div className={styles.dashboardInnerMostFrame}>
        ...
        <div className={styles.dashboardSecond}>
          ...
          <div className={styles.cards}>
            ...
            />
            <Card icon={mail} majorText="Send Email" minorText="Send detailed announcements" />
            <Card
              icon={importExport}
